    ...
    public partial class _100 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCalendars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryCalendars_Calendars_CalendarId",
                        column: x => x.CalendarId,
                        principalTable: "Calendars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryCalendars_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryCalendars_CalendarId",
                table: "CategoryCalendars",
                column: "CalendarId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryCalendars_CategoryId",
                table: "CategoryCalendars",
                column: "CategoryId");
        }
